...
$python ~/csa_vasp/util1/energydensity.py
"""
...
#ax.plot(density, energy, 'o', ms=5, lw=2, alpha=0.7, mfc='lawngreen')
#ax.plot(density, energy, 'o', ms=5, lw=2, alpha=0.7, mfc='lightgreen')
#ax.plot(density, energy, 'o', ms=5, lw=2, alpha=0.7, mfc='dodgerblue')
#ax.plot(density, energy, 'o', ms=5, lw=2, alpha=0.7, mfc='coral')
ax.plot(density, energy, 'o', ms=5, lw=2, alpha=0.7, mfc='chartreuse')
ax.grid()
tmp=np.amin(density)
tmq=np.amax(density)
ax.set_xlim(tmp,tmq)
