...
if True:
   ...
   pyprocar.bandsplot('PROCAR_repaired',outcar='OUTCAR',elimit=[-2,2],mode='plain',color='blue',kpointsfile='KPOINTS', savefig='bands.eps')
   pyprocar.bandsplot('PROCAR_repaired',outcar='OUTCAR',elimit=[-2,2],kpointsfile='KPOINTS',cmap='jet',mode='parametric', orbitals=[0], savefig='s_bands.eps')
   pyprocar.bandsplot('PROCAR_repaired',outcar='OUTCAR',elimit=[-2,2],kpointsfile='KPOINTS',cmap='jet',mode='parametric', orbitals=[1,2,3], savefig='p_bands.eps')
   pyprocar.bandsplot('PROCAR_repaired',outcar='OUTCAR',elimit=[-2,2],kpointsfile='KPOINTS',cmap='jet',mode='parametric', orbitals=[4,5,6,7,8], savefig='d_bands.eps' )
#  pyprocar.bandsplot('PROCAR_repaired',outcar='OUTCAR',elimit=[-2,2],kpointsfile='KPOINTS',cmap='jet',mode='parametric', atoms=[0,1,2,3], savefig='Si_bands.eps' )
#  pyprocar.bandsplot('PROCAR_repaired',outcar='OUTCAR',elimit=[-2,2],kpointsfile='KPOINTS',cmap='jet',mode='parametric', atoms=[4,5,6,7], savefig='Ge_bands.eps' )
if False:
   pyprocar.repair('PROCAR','PROCAR_repaired')
...
if False:
   ...
   pyprocar.dosplot(filename='vasprun.xml', mode='stack',colors=['green','orange','cyan'],items=dict(C=[0,1,2,3],S=[0,1,2,3],H=[0]), elimit=[-2,2], orientation='vertical', plot_total=True, savefig='dos.eps')
