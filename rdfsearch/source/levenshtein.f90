...
!*****************************************************************************80
!
!! LEVENSHTEIN_DISTANCE computes the Levenshtein distance between
!strings.
!
!  Discussion:
!
...
!
!    Output, integer ( kind = 4 ) DISTANCE, the Levenshtein distance
!    between the
!    two strings.
!
  implicit none
...
!*****************************************************************************80
!
!! LEVENSHTEIN_MATRIX computes the Levenshtein distance matrix between
!strings.
!
!  Discussion:
!
